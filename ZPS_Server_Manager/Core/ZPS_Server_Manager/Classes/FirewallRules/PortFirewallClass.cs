...
namespace ZPS_Server_Manager.Classes.FirewallRules
{
    internal class PortFirewallClass
    {
        ...
        private static INetFwRule2? CreateRule()
        {
            return Activator.CreateInstance(Type.GetTypeFromProgID("HNetCfg.FWRule")) as INetFwRule2;
        }
    }
}
